...
def test_edit_contact(app):
    ...
    app.contact.edit_contact((Contact(firstname="edit", middlename="edit", lastname="edit", nickname="alex2", title="zagolovok", company="corporation umbrella", address="vyzov",
